...
export default function Gallery() {
  ...
  const galleryImages = [
    ...
    { id: 2, category: "campus", src: "/rahu.png?height=300&width=400&text=Campus 2", alt: "Campus Garden" },
    {
      id: 3,
      category: "classrooms",
      src: "/rahu1.png?height=300&width=400&text=Classroom 1",
      alt: "Computer Lab",
    },
    {
      id: 4,
      category: "classrooms",
      src: "/rahu2.png?height=300&width=400&text=Classroom 2",
      alt: "Lecture Hall",
    },
    { id: 5, category: "events", src: "/rahu1.png?height=300&width=400&text=Event 1", alt: "Annual Function" },
    { id: 6, category: "events", src: "/rahu3.png?height=300&width=400&text=Event 2", alt: "Workshop" },
    {
      id: 7,
      category: "students",
      src: "/rahu5.png?height=300&width=400&text=Students 1",
      alt: "Students Working",
    },
    {
      id: 8,
      category: "students",
      src: "/rahu6.png?height=300&width=400&text=Students 2",
    ...
    { id: 9, category: "campus", src: "/placeholder-logo.png?height=300&width=400&text=Campus 3", alt: "Reception Area" },
    {
      id: 10,
      category: "classrooms",
      src: "/rahu7.png?height=300&width=400&text=Classroom 3",
      alt: "Programming Lab",
    },
    { id: 11, category: "events", src: "/rahu4.png?height=300&width=400&text=Event 3", alt: "Tech Fest" },
    {
      id: 12,
      category: "students",
      src: "/rahu7.png?height=300&width=400&text=Students 3",
